...
%	\end{frame}
	...
	\begin{frame}
		...
		\begin{description}
			\item[parameters:] A \textbf{number of cycles} can be passed as a parameter to an overloaded version of \code{think()}. This number of cycles represents the amount of \emph{effort} being put into thinking, running until energy-based quiescence \footfullcite{vybihal-knowledge} occurs. Otherwise, think() takes no parameters and runs to natural quiescence.
