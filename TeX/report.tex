...
The goal of this project is to create an artificial intelligence system called Prometheus to control and coordinate multiple robots. The robots themselves are expected to be relatively simple and do not make any decisions themselves. All the thinking and decision-making is done by Prometheus, which collects data from all the robots' sensors.
...
The robots in Prof. Vybihal's lab have two types of sensors: cameras and ultrasonic sensors. The ultrasonic sensors can measure distance between the robot and nearby objects, and the camera can take images of what the robot is facing.
